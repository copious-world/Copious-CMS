...
//
$user_orgin = $_POST['userid_origin'];
$nu_group_origin = $_POST['group_origin'];
...
Please select a new group name and password.
</span>
...
<?php echo $SERVICE; ?> has is ready to setup your new group.
<br>
<br>You may now select a group name and password.
<br>
...
<input type="hidden"  NAME="group_origin" value="<?php echo $nu_group_origin; ?>"  >
<input type="hidden"  NAME="group_user_origin" value="<?php echo $user_orgin; ?>"  >

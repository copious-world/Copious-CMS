...
g_expansionlist = [];	/// This is here for historical reasons...
	...
	INFOGROUP.topic_menu7 = {
		...
		app_action: null,
		cb:function() {
			universalWindow(this,"External E-Mail Address","topic1_7","mail_menu7","click");
		}
	}


	INFOGROUP.topic_menu8 = {
		needs:["window"],
		wind: null,
		save_width: 0,
		dontOpen: false,
		app_action: null,
		cb:function() {
			universalWindow(this,"Zip File Helper","topic1_8","zipFileHelper","click");
		}
	}
	...
	INFOGROUP.topic_menu9 = {
		...
		app_action: null,
		cb:function() {
			universalWindow(this,"Import Messages","topic1_9","mail_menu9","click");
		}
	}
	...
	INFOGROUP.topic_menu10 = {
		...
		app_action: null,
		cb:function() {
			universalWindow(this,"Export Messages","topic1_10","mail_menu10","click");
		}
	}
...
function messageToGroup(targetName) {
	...
	spanID = "statusReport";  // Get the group the message is supposed to go to. So that clicking send makes sense...
...
var g_application_group_menu_count = 5;

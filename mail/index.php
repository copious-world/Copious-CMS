...
?>
	...
	<script language="JavaScript" type="text/javascript" >
		g_application_group_menu_count = 6;
	</script>
...
<script language="javascript" type="text/javascript" src="/hosted/js/cvt/cvtinterface.js"></script>
	...
	<title>Copious Web Site Mail</title>
...
var SITE_LOGIN_RESULT = encodeURIComponent("mail/index.php");
...
<h1><a class="site-name title" style='padding-left:8px;' href="http://www.opensource-copious.org/">Copious Mail</a></h1>
</td>
<td width="2%">&nbsp;</td>
<td width="45%">
<div class="site-slogan" align='center' style='padding-right:8px;background-color:darkgreen'>
<a class="site-name title" style="color:gold" href="http://www.copious-systems.com/">Mail for Copious Systems</a><span style="margin-left:8px"> [ On the Net  &curren; Off the Gridt  &curren; Safe and Secure ]</span></div>
</td>
</tr>
...
<div class="menucontainer" style="width:95%" >
		...
		<span class="menuItemTxt" id="mail_menu1" onclick="doMailMenu(1);" >
				&nbsp;Mail From Group <span class="menuItemTitleTxt" id="mail_menu_span_1">bbb</span>
		</span><br>
		<hr color="navy">
		<span class="menuItemTxt" id="mail_menu2" onclick="doMailMenu(2);" >
				&nbsp;Mail Sent to Group <span class="menuItemTitleTxt" id="mail_menu_span_2">bbb</span>
		</span><br>
		<hr color="navy">
...
</div><div class="blockbar-title blockbar-2-title" onclick="blockbar_toggle('_block2_sub3','2')">      <div align="center" class="blockbar-head-img collapse" id="blockbarhead__block2_sub3">      </div>    <div class="blockbar-head blockbar-2-head" nowrap>Special Commands</div></div><div class="blockbar-content blockbar-2-content" id="_block2_sub3" style="display:none;">
<div class="menucontainer" style="width:95%" >
		...
		<span class="menuItemTxt" id="mail_menu10" >
				&nbsp;Archive Messages of Group <span class="menuItemTitleTxt" id="mail_menu_span_5">bbb</span>
		</span>
		<hr color="navy">
		<span class="menuItemTxt" id="mail_menu11" >
				&nbsp;View Mail Marked for Deletion
		</span><br>
		<hr color="navy">
		<span class="menuItemTxt" id="mail_menu12" onclick="message_eraser();" >
				&nbsp;Erase Marked Messages Permenantly
		</span>
</div>
...
<div class="statusReportStyle" id="statusReport">
status: ready.
</div>
	...
	<table width="90%" cellspacing="10" cellpadding="4" border="0" >
		<tr>
			<td width="100%" align="left" valign="top" >
				...
				<table width="100%">
					<tr><td width="100%" valign="top"><b><u>Subject</u>:</b>&nbsp;&nbsp;<input type="text" id="message_subject" size="80" NAME="add_title"  onselect="saveCaret(this)" onclick="saveCaret(this)" onkeyup="saveCaret(this)" onkeypress="return changeKey(this, event, fName);">
						<span style="padding:4px;font-size:0.95em;font-family:arial black;cursor:pointer;text-weight:bolder;color:darkgreen;border:solid 2px darkgreen;background-color:#FAFAAA;" onchange="languageChange($('langchoice').value);" >
					...
					<tr><td id="messageBox"  width="100%" align="left">
<div style="width:99%;text-decoration:none;font-weight:bold;font-size:0.9em;color:004411;font-family:arial;padding:2; background-color:#EFF0c2;border: 1px purple solid" >
<div style="width:99%;color:004411;font-family:arial;padding:3px; background-color:#FFFFE9;
				border-top: 1px black solid;border-left: 1px navy solid;border-right: 1px orange solid;;border-bottom: 1px #EBEBE2 solid;">
Message
</div>
<TEXTAREA name="message_text" rows="10" cols="90" onselect="saveCaret(this)" onclick="saveCaret(this)" onkeyup="saveCaret(this)" onkeypress="return changeKey(this, event, fName)" ID="message_text" style="width:90%"></TEXTAREA> 
</div>
					</td></tr>
				</table>
<div align="center" >
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" value="Send Message" ID="Submit1" NAME="Submit1" onclick="javascript:MessageAndAttach_Sender('sendMailMessage');">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" value="Send Regular E-Mail" ID="Submit1" NAME="Submit1" onclick="javascript:MessageAndAttach_Sender('sendEMail');">
		...
		<tr>
			<td>
				<table>
					<tr>
					<td width="30%" valign="top" align="center" onClick="fileAttachUploading();" target="testUpload">
						<span id="zipattachControl" class="messageBoxControl" >Attach Zipped File</span>
					</td>
					<td width="70%" valign="top" align="center" >
						<form id="uploaderForm" method="POST" enctype="multipart/form-data" action="uploadAttachment.php" target="testUpload">
							<input type="hidden" name="userid" value="<?php echo $pnumber; ?>" >
							<input type="hidden" id="attachfilekey" name="attachfilekey" value="" >
							<input type="hidden" name="doupload" value="1234" >
						<span id="uploaderDisplay" >
							<input id="uploaderFile" name="uploaderFile" type="file" accept="application/zip" onchange='return checkExt("zip,gz",this);' >
							&nbsp;&nbsp;<span class="messageBoxControl" id="zipFileHelper" >ZIP File Helper</span>
							
				<iframe name="testUpload" style="visibility:hidden;height:1px;width:2px;" >
				</iframe>
						</span>
						</form>
					</td>
					...
					<tr>
						<table>
						<tr>
							<td width="30%" valign="top" align="right" style="text-weight:bold;color:navy;border-top:solid 1px darkgreen;">
								Outside E-mail Addresses:
							</td>
							<td width="55%" valign="top" align="left" >
								<span id="emaillist" style="text-weight:bold;color:darkgreen;border-top:solid 1px darkgreen;" > </span>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<span style="padding:4px;font-size:0.85em;font-family:arial black;cursor:pointer;text-weight:bolder;color:darkgreen;border:solid 2px darkgreen;background-color:#FAFAAA;" onclick="invitations($('emaillist').innerHTML);" >
								Invite Addressees
								</span>
							</td>
						</tr>
...
<div style="overflow:auto" >
	<div style="border-top:solid 2px darkgreen;border-right: solid 2px green;border-left:solid 1px gray;border-bottom: solid 1px gray;padding: 10px;" >
	Enter an e-mail address. Your message will be sent to this address through standard internet mail.<br>
	This e-mail does not have to belong to a user of this mail system.<br>
	The recipient of this e-mail may receive an offer to join your group on this systems.<br>
	The carriage return will complete this action.<br>
	<form action="javascript:addemail();" >
		<span style="font-weight:bold;color:darkred;" >standard e-mail address:</span> <input id="newemail" type="text" size="35">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" value="update list">
	</form>
	<br>
	The following list is the list of external e-mail addresses that you have added.
	<br>
	You can edit this list if you need to change an address or delete it.<br>
	<form action="javascript:changeemail(1);" >
		<span style="font-weight:bold;color:darkred;" >address list:</span><br>
		<TEXTAREA name="emailEntryFormList" rows="5" cols="40" ID="emailEntryFormList"></TEXTAREA> 
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" value="update list">
	</form>	
...
<div style="overflow:auto" >
<br>
You can send attachments with your messages, both within the copious mail system and externally as well to regular mail.
<br><br>
However, this system expects the attachments to be soley ZIP or GZIP files.
<br><br>
Many are familiar with zip files. But not all.
<br><br>
For those who wish to know, the choice to send just zipped files for a few reasons.
This choice is for economy, simplicity, and eventually security.
The zipped files are compressed collections of files. So, more data goes with the message in less space.
You can send any type of file in the collection. Standard tools are available to help you extract the files from the 
collection, when you receive the zip files.
</td>
<td width="60%"  valign="top" >
<br>
Download the zip helper.
</div>
</div>
...
<table >
	<tr>
		<td width="50%"  class="messageBoxControl" valign="middle" align="center" onClick="getPOP3Messages();" >
		Get Mail from My Default Message Box
		</td>
	</tr>
</table>
...
This features creates a text zip file out for your in box for the currently selected group.
The link to the file is provided in a message, which you will receive after a chron job runs.
This job runs only once every 6 hours.


<table >
	<tr>
		<td width="50%"  class="messageBoxControl" valign="middle" align="center" onClick="sendMessagesToZipFile();" >
		Save Mail to Zip File
		</td>
	</tr>
</table>

...
try {
	...
	function get_last_seqname($refnumber) {
		...
		$q_result = @mysqli_query($section_retriever) or die (mysqli_error($db_connection));  // 
		////	
		$fname = "";
...
<html>
	...
	<script language="javascript">
		...
		function makeChange(whichchange) {
			...
			var url = "employerapproval.php?refnumber=<?php echo $refnumber; ?>&section_number=<?php echo $section_number; ?>&change_action=";
			url += whichchange + "&";
	...
	<form>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%" ID="Table1">
			...
			<a href="javascript:hideDiv('change_title');" style="background-color:#FFFFE0;padding:2;font-size:12;text-align:center;text-decoration:none;border: solid 1px brown">
			&nbsp;close&nbsp;
			</a>
			</td>
			<td width="50%" style="text-align:center;background-color:#FEFEEE;border-top: solid 1px darkred">
				<a href="javascript:makeChange('title');" style="background-color:#FFFFE0;padding:2;font-size:12;text-align:center;text-decoration:none;border: solid 1px green"> 
				&nbsp;make change&nbsp;
				</a>
	...
	<form>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%" ID="Table1">
			<tr>
			<td width="15%" style="text-align:center;background-color:#FEFEEE;border-top: solid 1px darkred">
			<a href="javascript:hideDiv('change_shortdescr');" style="background-color:#FFFFE0;padding:2;font-size:12;text-align:center;text-decoration:none;border: solid 1px brown">
			&nbsp;close&nbsp;
			</a>
			</td>
			<td width="50%" style="text-align:center;background-color:#FEFEEE;border-top: solid 1px darkred">
				<a href="javascript:makeChange('short description');" style="background-color:#FFFFE0;padding:2;font-size:12;text-align:center;text-decoration:none;border: solid 1px green"> 
				&nbsp;make change&nbsp;
				</a>
			</td><td width="30%" style="background-color:#FEFEEE">&nbsp;</td>
			</tr>
	...
	<form>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%" ID="Table1">
			<tr>
			<td width="15%" style="text-align:center;background-color:#FEFEEE;border-top: solid 1px darkred">
			<a href="javascript:hideDiv('change_longdescr');" style="background-color:#FFFFE0;padding:2;font-size:12;text-align:center;text-decoration:none;border: solid 1px brown">
			&nbsp;close&nbsp;
			</a>
			</td>
			<td width="50%" style="text-align:center;background-color:#FEFEEE;border-top: solid 1px darkred">
				<a href="javascript:makeChange('long description');" style="background-color:#FFFFE0;padding:2;font-size:12;text-align:center;text-decoration:none;border: solid 1px green"> 
				&nbsp;make change&nbsp;
				</a>
			</td><td width="30%" style="background-color:#FEFEEE">&nbsp;</td>
			</tr>
...
<!--  <input type="submit" name="imagePOST" value="upload" /> -->
		<table cellpadding="0" cellspacing="0" border="0" width="100%" ID="Table1" >
			<tr>
			<td width="15%" style="text-align:center;background-color:#FEFEEE;border-top: solid 1px darkred">
			<a href="javascript:hideDiv('add_picture');" style="background-color:#FFFFE0;padding:2;font-size:12;text-align:center;text-decoration:none;border: solid 1px brown">
			&nbsp;close&nbsp;
			</a>
			</td>
			<td width="40%" style="text-align:center;background-color:#FEFEEE;border-top: solid 1px darkred">
				<a href="javascript:makeChange('picture');" style="background-color:#FFFFE0;padding:2;font-size:12;text-align:center;text-decoration:none;border: solid 1px green"> 
				&nbsp;make change&nbsp;
				</a>
			</td>
	...
	<form>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%" ID="Table1">
			<tr>
			<td width="15%" style="text-align:center;background-color:#FEFEEE;border-top: solid 1px darkred">
			<a href="javascript:hideDiv('change_price');" style="background-color:#FFFFE0;padding:2;font-size:12;text-align:center;text-decoration:none;border: solid 1px brown">
			&nbsp;close&nbsp;
			</a>
			</td>
			<td width="50%" style="text-align:center;background-color:#FEFEEE;border-top: solid 1px darkred">
				<a href="javascript:makeChange('price');" style="background-color:#FFFFE0;padding:2;font-size:12;text-align:center;text-decoration:none;border: solid 1px green"> 
				&nbsp;make change&nbsp;
				</a>
			</td><td width="30%" style="background-color:#FEFEEE">&nbsp;</td>
			</tr>
		...
		<div id="column2" style="padding:10;width:35%;" >
			<br>
			<span style="color:#004422;font-weight:bold;font-size:14;background-color:#EEFFBB;border-bottom:1px solid #AAEE88">Accept Ad Content and Publish</span>
			...
			<br>
			<span style="color:#004422;font-weight:bold;font-size:14;background-color:#EEFFBB;border-bottom:1px solid #AAEE88">Delete Ad From System</span>
			<table border="0" cellspacing="8" cellpadding="1" width="100%" ID="Table1">
			<tbody>
				<tr>
					<td width="10%">&nbsp;</td>

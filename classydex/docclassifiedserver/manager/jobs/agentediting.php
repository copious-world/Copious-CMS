...
<html>
	...
	<script language="javascript">
		...
		function makeChange(whichchange) {
			...
			var url = "agentediting.php?refnumber=<?php echo $refnumber; ?>&section_number=<?php echo $section_number; ?>&change_action=";
			url += whichchange + "&";
...
<!--  <input type="submit" name="imagePOST" value="upload" /> -->
	...
	<form>
		...
		<div id="column2" style="padding:10;width:35%;" >
			<span style="color:#004422;font-weight:bold;font-size:14;background-color:#EEFFBB;border-bottom:1px solid #AAEE88">Selections for change:</span>

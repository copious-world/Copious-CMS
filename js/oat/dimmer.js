/*
 *  $Id: dimmer.js,v 1.7 2007/05/18 12:03:38 source Exp $
 *
...
OAT.Dimmer = {
	...
	show:function(something,optObj) {
		...
		elm.style.zIndex = OAT.Dom.maxZ(1000);
		
		OAT.Dimmer.root = OAT.Dom.create("div",{position:"fixed",left:"0px",top:"0px",width:"100%",height:"100%",zIndex: (elm.style.zIndex - 2) });

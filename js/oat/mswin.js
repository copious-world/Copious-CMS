...
OAT.MsWin = function(optObj) {
	...
	var imgUrl = self.options.imagePath;

	if (this.closeBtn) {
		OAT.Dom.applyStyle(this.closeBtn,{cssFloat:"right",styleFloat:"right",fontSize:"1px",marginTop:"1px",cursor:"pointer",width:"16px",height:"14px",
			backgroundImage: "url(" + imgUrl  + "MsWin_close.png)" });
	}
	...
	if (this.resize) {
		OAT.Dom.applyStyle(this.resize,{width:"10px",height:"10px",fontSize:"1px",position:"absolute",right:"0px",bottom:"0px",cursor:"nw-resize",backgroundImage:"url(" + imgUrl + "MsWin_resize.gif)"});
	}
}

...
$QQ = "SELECT id FROM vocabulary WHERE ( serviceid = $serviceid ) AND ( name = 'polls' )";
$poll_taxo_id = db_query_value($QQ);
...
<head>
	...
	<title><?php echo $bus_appdir; ?> Polls</title>

</head>
<script type="text/javascript" language="javascript">

var g_poll_taxo_id = <?php echo $poll_taxo_id; ?>;
...
<td width="20%" valign="top" style="border:1px solid gold;" >
		<div style="text-align:center;background-color:darkgreen;color:gold;border:1px solid gold;font-weight:bold;font-size:1.2em" >Polls by Topic</div>
...
Current poll: <span id="pollTitle" class="pollTitle" ></span>
			</td>
			</tr>
			</table>
		</div>
...
<div style="overflow:auto" >
	...
	<span id="posterHitBtn" class="buttonLike">Post a Topic for the following category: <span id="posterpoll" class="pollTitle" ></span></span>
	</div>
	<div class="pollFormContainer" >
	<form id="topic_submit_form"  method="POST" action="../polls/posttopic.php" target="postResponseLayer" >

<div class="pollPostEl" >
<span class="pollTitle pollTitleEl" >Title:</span><input id="topic_submit_title"  type="text" name="title" style="width:80%">
</div>
<br>
<div class="pollPostEl" >
<span class="pollTitle" >Topic Entry:</span><br>
...
<div style="margin-left:20px;padding-top:10px;padding-bottom:10px;" >
<span id="form_instruct" class="sys_describe" > Click this button to <span id="search_button" class="buttonLike" >SEARCH <span id="search_poll" class="pollTitle" >no poll selected </span></span> for the keyed fields below.</span> 
</div>
...
<span id="form_instruct" class="pollTitle" >Search by Title:<span id="title_search" style="visibility:inherit" >
...
<span id="form_instruct" class="pollTitle" >Use Key words:<span id="title_search" style="visibility:inherit" >
...
<div style="overflow:auto" >
	<span id="singleItemEntrySpan">&nbsp;</span>
</div>
</div>

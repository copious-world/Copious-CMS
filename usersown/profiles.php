...
var SITE_LOGIN_RESULT = encodeURIComponent("usersown/index.php");
...
<h1><a class="site-name title" style='padding-left:8px;' href="http://www.opensource-copious.org/">Profile Access for User <span class="theme_user_name"><?php echo $username; ?></span></a></h1>
</td>
<td width="2%">&nbsp;</td>
<td width="45%">
...
<div class="menucontainer" style="width:95%" >
		<span class="menuItemTxt" id="mail_menu2" >
				&nbsp;My Profile <span class="menuItemTitleTxt" id="mail_menu_span_2">bbb</span>
		</span><br>
		<hr color="navy">
		<span class="menuItemTxt" id="mail_menu3" onclick="doMailMenu(3);" >
				&nbsp;Profiles From  Group <span class="menuItemTitleTxt" id="mail_menu_span_3">bbb</span>
		</span><br>
</div>
...
<div style="overflow:auto" >
<form id="bookform" method="POST" action="/hosted/usersown/saveprofile.php" target="_blank" onsubmit="return prepare_profile_theme_fields();">
<input type="submit" name="publishaction" value="save">
<span class="buttonLike" onclick="preview_book_theme(this)">Preview</span>
<?php

	global $g_current_theme;
	include("profileprep.php");
...
<td class="sys_td" width="30%" >
<form method="POST"  action="/hosted/usersown/uploadimage.php"  enctype="multipart/form-data" target="image_uploader" onsubmit="imagerefresh();">
Select an image for uploading (this needs to be a small jpg about 150x150 px:
		<input type="file" id="ad_picture" size="80" NAME="ad_picture" value=" " accept="image/jpeg" >
<br>
...
<td class="sys_td" width="30%" style="text-align:center;">
<iframe id="image_uploader" name="image_uploader" >
image goes here
</iframe>
</td>
